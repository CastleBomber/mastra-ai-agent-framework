...
export declare function createPrepareMemoryStep<OUTPUT = undefined>({ capabilities, options, threadFromArgs, resourceId, runId: _runId, requestContext, instructions, memoryConfig, memory, isResume, }: PrepareMemoryStepOptions<OUTPUT>): import("../../../workflows").Step<"prepare-memory-step", unknown, Record<string, never>, {
    ...
    initialSignalEchoes?: import("../..").CreatedAgentSignal[] | undefined;
