...
export declare function createMapResultsStep<OUTPUT = undefined>({ capabilities, options, resourceId, runId, requestContext, memory, memoryConfig, agentSpan, agentId, methodType, saveQueueManager, }: MapResultsStepOptions<OUTPUT>): Step<string, unknown, {
