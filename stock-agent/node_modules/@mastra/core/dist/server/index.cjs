...
var chunkD46HNNLH_cjs = require('../chunk-D46HNNLH.cjs');

// src/server/auth.ts
var MastraAuthProvider = class extends chunkNDJ35CK6_cjs.MastraBase {
  protected;
  public;
  constructor(options) {
...
// src/server/base.ts
var MastraServerBase = class extends chunkNDJ35CK6_cjs.MastraBase {
  #app;
  constructor({ app, name }) {
    super({ component: chunkD46HNNLH_cjs.RegisteredLogger.SERVER, name: name ?? "Server" });
    this.#app = app;
  }
  /**
