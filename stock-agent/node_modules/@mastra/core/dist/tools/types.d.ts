...
import type { Tool, ToolV5, FlexibleSchema, ToolCallOptions, ToolExecutionOptions, Schema } from '../_types/@internal_external-types/dist/index.d.ts';
...
export type ToolPayloadTransformPhase = 'input-delta' | 'input-available' | 'output-available' | 'error' | 'approval' | 'suspend' | 'resume';
...
export type ToolPayloadTransformFunction<TInput = unknown, TOutput = unknown, TError = unknown> = (context: ToolPayloadTransformContext<TInput, TOutput, TError>) => ToolPayloadTransformResult | Promise<ToolPayloadTransformResult>;
...
export type ToolPayloadTransform<TInput = unknown, TOutput = unknown, TError = unknown> = Partial<Record<ToolPayloadTransformTarget, ToolPayloadTransformTargetConfig<TInput, TOutput, TError>>>;
 ...
 * null-check `observe`.
 */
export declare const noopObserve: ToolObserve;
/**
