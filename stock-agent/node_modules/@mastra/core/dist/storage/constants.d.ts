...
export declare const SPAN_SCHEMA: Record<"error" | "runId" | "requestContext" | "input" | "threadId" | "resourceId" | "metadata" | "source" | "output" | "createdAt" | "name" | "traceId" | "spanId" | "updatedAt" | "spanType" | "isEvent" | "startedAt" | "parentSpanId" | "experimentId" | "attributes" | "links" | "endedAt" | "tags" | "entityType" | "entityId" | "entityName" | "parentEntityType" | "parentEntityId" | "parentEntityName" | "rootEntityType" | "rootEntityId" | "rootEntityName" | "userId" | "organizationId" | "sessionId" | "requestId" | "environment" | "serviceName" | "scope", StorageColumn>;
/**
